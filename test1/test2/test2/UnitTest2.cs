...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
    ...
    public void Test()
    {
        ...
        IAction keydown = actionProvider.KeyDown(Keys.Control).SendKeys("\uE015").Build();
        keydown.Perform();
        WebDriverWait w = new WebDriverWait(driver, TimeSpan.FromSeconds(2000));
        w.Until(ExpectedConditions.ElementExists(By.XPath("//div[@id='search-filter-results-37']/div[2]/div[2]/a/div/div/div/h3")));
        driver.FindElement(By.XPath("//div[@id='search-filter-results-37']/div[2]/div[2]/a/div/div/div/h3")).Click();
        ...
        Assert.That(driver.FindElement(By.CssSelector(".utbildninger--program-meta_lia > .meta_text")).Text, Is.EqualTo("Två LIA-perioder | Totalt: 20 veckor"));
        ...
        Assert.That(driver.FindElement(By.CssSelector(".utbildninger--program-meta_poang > .meta_text")).Text, Is.EqualTo("405 Yhp"));
        ...
        Assert.That(driver.FindElement(By.CssSelector(".utbildninger--program-meta_studieort > .meta_text")).Text, Is.EqualTo("Malmö, Helsingborg"));
    }
}