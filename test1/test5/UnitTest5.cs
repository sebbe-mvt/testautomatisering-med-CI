...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
    ...
    public void Test()
    {
        ...
        w.Until(ExpectedConditions.ElementExists(By.XPath("//div[@id='search-filter-results-37']/div[2]/div[3]/a/div/div/div/h3")));
        driver.FindElement(By.XPath("//div[@id='search-filter-results-37']/div[2]/div[3]/a/div/div/div/h3")).Click();
        ...
        Assert.That(driver.FindElement(By.CssSelector(".utbildninger--program-meta_lia > .meta_text")).Text, Is.EqualTo("Två LIA-perioder | Totalt: 21 veckor"));
        ...
        Assert.That(driver.FindElement(By.CssSelector(".utbildninger--program-meta_studieort > .meta_text")).Text, Is.EqualTo("Göteborg, Halmstad, Helsingborg, Karlstad, Örebro"));
    }
}