...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
    ...
    public void Test()
    {
        ...
        driver.FindElement(By.XPath("//div[@id='search-filter-results-37']/div/div[2]/a/div/div/div/h3")).Click();
        ...
        Assert.That(driver.FindElement(By.CssSelector(".utbildninger--program-meta_studieort > .meta_text")).Text, Is.EqualTo("Stockholm, Växjö, Örebro"));
        }
}